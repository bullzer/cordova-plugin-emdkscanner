...
public class EmdkScanner extends CordovaPlugin implements Serializable, EMDKManager.EMDKListener, Scanner.StatusListener, Scanner.DataListener, BarcodeManager.ScannerConnectionListener {

	private static final String LOG_TAG = "EmdkScanner";
	...
	public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
		...
		if (action.equals("init")) {
			if (mScanner != null && mScanner.isEnabled()) {
				...
				final EmdkScanner myEMDKScanner = this;
				cordova.getThreadPool().execute(new Runnable() {
					public void run() {
						initialisationCallbackContext = callbackContext;

						try {
							EMDKResults results = EMDKManager.getEMDKManager(cordova.getActivity().getApplicationContext(), myEMDKScanner);
